...
let deportista = {
    ...
    let energiaQuitada = cantidadDeHoras * 5 
    this.energia -= energiaQuitada

    dobleHoras = cantidadDeHoras * 2
    this.experiencia += dobleHoras
    return "Energia restante " + this.energia + ". Experiencia ganada " + this.experiencia
}
}
